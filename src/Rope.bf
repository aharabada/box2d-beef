...
namespace Box2D
{
	...
	static class Rope
	{
		[LinkName("b2Rope_Create")] public static extern b2Rope* Create(in b2RopeDef def);
		[LinkName("b2Rope_Destroy")] public static extern void Destroy(b2Rope* rope);
		[LinkName("b2Rope_SetTuning")] public static extern void SetTuning(b2Rope* rope, in b2RopeTuning v);
		[LinkName("b2Rope_Step")] public static extern void Step(b2Rope* rope, float timeStep, int32 iterations, in b2Vec2 position);
		[LinkName("b2Rope_Reset")] public static extern void Reset(b2Rope* rope, in b2Vec2 v);
