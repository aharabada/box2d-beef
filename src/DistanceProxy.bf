...
namespace Box2D
{
	...
	static class DistanceProxy
	{
		...
		[LinkName("b2DistanceProxy_GetSupport")] public static extern int32 GetSupport(b2DistanceProxy* distanceProxy, in b2Vec2 d);
		[LinkName("b2DistanceProxy_GetSupportVertex")] public static extern b2Vec2 GetSupportVertex(b2DistanceProxy* distanceProxy, in b2Vec2 d);
